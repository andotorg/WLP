		...
		<form id="dom_formfarmqztask">
			...
			<table class="editTable">
				...
				<tr>
					<td class="title">类:</td>
					<td colspan="3">
						实现了org.quartz.Job接口的类（如：com.farm.quartz.test.MyJob） <br /> <input
						class="easyui-combobox" style="width: 360px;" id="entity_jobclass"
						name="jobclass" value="${entity.jobclass}"
						data-options="required:true,validType:',maxLength[64]',valueField: 'value', textField: 'label', data: [
						
						//{ label: 'LDAP组织机构同步', value: 'com.farm.wcp.oauth2.ldap.task.AutoSyncOrgsJob' },
						
						{ label: '命令行任务', value: 'com.farm.quartz.job.impl.CommandRuningJob' }]" />
					</td>
				</tr>
				<tr>
					<td class="title">任务参数:</td>
				...
				<tr>
					...
					<td colspan="3"><textarea rows="3" style="width: 360px;"
							class="easyui-validatebox"
